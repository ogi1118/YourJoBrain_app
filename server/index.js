...
app.post('/api/pages', (req, res) => {
    ...
    const userId = 1;
    const query = 'INSERT INTO Companies (user_id, company_name, memo) VALUES (?, ?, ?)';
...
app.get('/api/pages/:title', (req, res) => {
    ...
    const query = 'SELECT company_name AS title, memo AS content FROM Companies WHERE company_name = ?';
